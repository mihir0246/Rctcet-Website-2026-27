...
function MomentBox({image, alt}) {
    return(
        <div className="group mx-2 lg:mx-3 shrink-0 relative perspective-1000">
            ...
            <div className="p-3 pb-8 md:p-4 md:pb-12 bg-white/60 dark:bg-card/40 backdrop-blur-2xl border border-white/60 dark:border-white/10 rounded-3xl shadow-xl transition-all duration-500 ease-out hover:-translate-y-4 hover:rotate-3 hover:shadow-[0_20px_40px_rgb(var(--primary)/0.2)] hover:z-10 relative">
                {/* Image Wrapper */}
