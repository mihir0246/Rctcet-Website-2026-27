    ...
    <div className="p-8 bg-white dark:bg-[#1A1612]">
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        {filteredMembers.length > 0 && (
          <div className="max-w-[80%] mx-auto">
            <motion.div key={selectedYear} variants={containerVariants} initial="hidden" animate="visible" viewport={{ once: true, margin: "-50px" }} className="grid grid-cols-1 md:grid-cols-3 gap-20 mt-8">
      ...
      {filteredBoDs.length > 0 && (
        <div className="mt-32 mb-24">
          ...
          <div className="max-w-[80%] mx-auto">
            <motion.div variants={containerVariants} initial="hidden" animate="visible" viewport={{ once: true, margin: "-50px" }} className="grid grid-cols-1 md:grid-cols-3 gap-20">
