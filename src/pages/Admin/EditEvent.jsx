  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        ...
        // Google sheets ISO date strings for date and time are clean, but inputs need standard formats.
        // The date from the backend is "23 Aug, 2026", time is "10:00 AM". 
        // We will need to properly format them or just allow the user to type them, but it's tricky to reverse parse.
        // To simplify, we will just dump the raw response into the form. The user might need to re-select date/time if they want to change them.
