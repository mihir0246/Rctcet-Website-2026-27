export const aboutImages = {
  ...
  rightStack1: "https://res.cloudinary.com/dtc2xaeaf/image/upload/v1757942004/image_18_sxzx2e.webp",
  rightStack2: "https://res.cloudinary.com/dtc2xaeaf/image/upload/v1757942002/17_ktizbs.webp",
...
export const objectivesList = [
  {
    title: "Focus Areas",
    description: "Projects and initiatives in Community Service, International Service, Professional Service, and other avenues like Sports, Editorial, Digital Communications."
  },
  {
    title: "Organization Goals",
    description: "A service, leadership, professional, and community service organization dedicated to fostering leadership, skill development, and impactful service."
  },
  {
    title: "Mission",
    description: "Develop young adults as leaders, respect others' rights, promote ethical standards, and address community needs."
  },
  {
    title: "Opportunities",
    description: "Exchange ideas with community leaders, develop leadership skills, and collaborate with Rotary clubs."
  },
  {
    title: "Role",
    description: "Facilitate the sharing of ventures and act as a catalyst for responsible youth development."
  }
];
